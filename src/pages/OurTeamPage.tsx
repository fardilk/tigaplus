...
// Responsive profile image component
function TeamMemberImage({ name, image }: { name: string; image: string }) {
  return (
    <img
      src={image}
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-4xl mx-auto">
            {teamMembers.map((member) => (
              ...
              >
                ...
                >
                  {/* Avatar Section */}
                  <div className="bg-gradient-to-br from-primary/20 to-primary/5 w-full aspect-square overflow-hidden">
